...
<link rel="stylesheet" href="${ctxStatic}/meetime/assets/font-awesome/4.4.0/css/font-awesome.min.css" />

<!-- page specific plugin styles -->

<!-- text fonts -->
<link rel="stylesheet" href="${ctxStatic}/meetime/assets/css/ace-fonts.css" />
